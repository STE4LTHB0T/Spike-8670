...
levelnum = [5,10,35,50,65,80]

cluster = MongoClient(os.environ['MONGO'])

ranking = cluster["discord"]["bounty"]
spam_channels = [461661510520012800,435765743766863882,478568350080040970,479645984658292737,546632755476300045,775031354374225930,785081153949663242,479139129230360576,791954505678979072,773266465678950520,792260571130626058,802877502661197874,889155434051674132,766960367116877834]
