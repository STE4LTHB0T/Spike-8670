...
from cogs.musicbot import utils
...
class General(commands.Cog):
    ...
    @commands.command(name='disconnect', description=config.HELP_DISCONNECT_LONG, help=config.HELP_DISCONNECT_SHORT, aliases=['leave'])
